...
function (_Component) {
  ...
  function RequestNew() {
    ...
    function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
        var campaign, _this$state, description, value, receiptent, accounts;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this$state = _this.state, description = _this$state.description, value = _this$state.value, receiptent = _this$state.receiptent;
              ...
              case 7:
                ...
                _context.next = 10;
                return campaign.methods.createRequest(description, _ethereum_web3__WEBPACK_IMPORTED_MODULE_12__["default"].utils.toWei(value, 'ether'), receiptent).send({
                  from: accounts[0]
                });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestNew, [{
    ...
    value: function render() {
      ...
      })), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Form"].Field, null, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("label", null, "Receipient"), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Input"], {
...
//# sourceMappingURL=new.js.1b501ab56ba0cd04d42e.hot-update.js.map